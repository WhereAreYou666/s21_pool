...
void s21_strlen_test() {
    char *good = "abc";
    char *bad = "aaaaaaaaaaaaaaaaaaaaaaaaaa";
    char *empty = "";
...
void s21_strcpy_test() {
    char source1[1000] = "abc";
    char source2[1000] = "abc";
    char source3[1000] = "abc";
    char target1[1000] = "abc";
    char target2[1000] = "abc";
    char target3[1000] = "abc";
    char *good = "abcd";
    char *bad = "aaaaaaaaaaaaaaaaaaaaaaaaaa";
    char *empty = "";
